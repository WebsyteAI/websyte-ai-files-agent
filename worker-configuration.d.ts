// Generated by Wrangler by running `wrangler types` (hash: 8539d0f69d91041f674df672ed7ba647)
...
declare namespace Cloudflare {
	interface Env {
		...
		Chat: DurableObjectNamespace<import("./server/index").Chat>;
		TestMcpAgent: DurableObjectNamespace<import("./server/index").TestMcpAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISPATCH_NAMESPACE_NAME" | "DISPATCH_NAMESPACE_ACCOUNT_ID" | "OPENAI_API_KEY" | "CLOUDFLARE_API_TOKEN" | "GITHUB_PERSONAL_ACCESS_TOKEN">> {}
}
